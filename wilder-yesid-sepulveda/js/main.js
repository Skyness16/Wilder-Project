...
const Products = (() => {
  ...
  const PRODUCTOS = [
    ...
    {
      id: 4, category: 'compactadora', brand: 'Wacker Neuson', name: 'Rodillo Compactador RD 45',
      desc: 'Rodillo dúplex autopropulsado para compactación de asfalto y subbase en proyectos viales.',
      price: '145.000.000', tag: 'stock', tagLabel: 'En Stock',
      specs: { 'Peso operacional': '4.2 ton', 'Ancho de trabajo': '1.2 m', 'Amplitud vibradora': '0.8 mm', 'Frecuencia': '64 Hz' },
      longDesc: 'El RD 45 combina alto rendimiento de compactación con excelente maniobrabilidad. Su cabina ROPS/FOPS certificada garantiza la seguridad del operador en todo momento.'
    },
    {
  ...
  function abrirModal(id) {
    ...
    modal.querySelector('.modal-img').innerHTML     = getIcono(p.category);
